...
(function() {
    var d, e, f, g, h, k, l, m, n, q, r, s, t, u, v, w, x, z = function() {
            var a = {};
            ...
            a.allowCrossExtensionHistory = t.checked ? "true" : "false";
            a.enableHttps = "true";
        ...
        F = function() {
            ...
            C();
            A(k, a.popupDblclickKey);
            A(n, a.popupSelectKey);
            q.checked = "true" === a.storeHistory;
            t.checked = "true" === a.allowCrossExtensionHistory;
            D();
            chrome.storage.local.get("word-history", function(a) {
                r = a = Object.keys(a["word-history"]).length;
                s.innerHTML = a;
                E()
            })
        },
        E = function() {
            0 < r && q.checked ? (v.disabled = !1, x.disabled = !1) : 0 === r && (v.disabled = !0, x.disabled = !0)
        },
        G = function(a) {
            var b = "";
            a = a["word-history"];
            for (var c in a) var p = c.split("<"),
                ...
                b = b + H,
                b = b + "\n";
            w.href = window.URL.createObjectURL(new Blob([b], {
                type: "text/plain"
            }));
            b = w;
        ...
        I = function() {
            chrome.storage.local.get("word-history", G)
        },
        J = function() {
    ...
    (function() {
        ...
        s = document.getElementById("num-words-in-history");
        t = document.getElementById("allow-cross-extension-history-checkbox");
        u = document.getElementById("allow-cross-extension-history-text");
        v = document.getElementById("download-history-btn");
        w = document.getElementById("download-history-link");
        x = document.getElementById("clear-history-btn");
        r = 0;
        ...
        v.addEventListener("click",
            I, !1);
        x.addEventListener("click", J, !1);
        document.getElementById("year").innerText = (new Date).getFullYear();
        for (var a = document.getElementsByTagName("input"), b = 0, c; c = a[b]; b++) c.addEventListener("change", K, !1);
        a = document.getElementsByTagName("select");
        for (b = 0; c = a[b]; b++) c.addEventListener("change", K, !1); - 1 !== window.navigator.platform.toLowerCase().indexOf("mac") && (document.getElementById("popup-dblclick-key-ctrl").innerHTML = "Command", document.getElementById("popup-select-key-ctrl").innerHTML = "Command");
        F()
    })();
})();