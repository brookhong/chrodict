...
(function() {
    var f = "\" ' ( ) , - . / 0 1 2 : ? a about and are as be but com for from have i in is it like may more my next not of on search that the this to was when with you your".split(" "),
        ...
        F = function(a, b, c) {
            ...
            _gaq && _gaq.push(["_trackEvent", "lookup", a.type]); - 1 !== s && v !== a.instanceId && chrome.tabs.sendMessage(s, {
                type: "hide",
                instanceId: v
            });
            ...
            var d = x(a.query),
                e = function() {
                    ...
                    C(d, p.language, function(a) {
                        b.dictRes = a;
                        D(b)
                    });
                    "en" !== p.language ? C(d, "en", function(a) {
                        b.enDictRes = a;
                        D(b)
                    }) : D(b);
                    E(d, "auto", function(a) {
                    ...
                    chrome.tabs.getSelected(null, function(a) {
                        ...
                        chrome.tabs.detectLanguage(a.id, function(a) {
                            b.tabLangTranReqTimedOut || (window.clearTimeout(c),
                                "und" !== a ? (b.tabLang = "he" === a ? "iw" : a, E(d, b.tabLang, function(a) {
                                    b.tabLangTranRes = a;
                                    D(b)
                                })) : D(b))
                        })
        ...
        C = function(a, b, c) {
            ...
            gapi.client.request(a).execute(function(a) {
                a = G(a, "dictionaryData[0]");
                if (!a) return c(null);
                var b = function(a) {
                        if (!a.senseFamilies) return 0;
                        a = a.senseFamilies;
                        for (var b = a.length, c = 0; c < a.length; c++) a[c].senses && (b += 0.1 * a[c].senses.length);
                        return b
                    },
                    k = function(a, c) {
                        return b(c) - b(a)
        ...
        D = function(a) {
            ...
            if (4 === a.numResponses) {
                var b = H(a.dictRes),
                    c = b;
                "en" !== p.language && (c = H(a.enDictRes));
                var d = I(a.tranRes, !0),
                    e = I(a.tabLangTranRes, !0),
                ...
                c =
                    "";
                g && (c = "http://translate.google.com/translate_t?source=dict-chrome-ex&sl=" + l.srcLang + "&tl=" + p.language + "&q=" + e);
                ...
                if ("fetch_html" === a.request.type) b = "", b = g ? J(n, l.audio, c) : K(a.dictRes, d), g = {
                    ...
                    var h = null,
                        t = null;
                    g ? (h = l, h.moreUrl = c) : b && (h = b, h.moreUrl =
                        d, h.srcLang = p.language);
                    h && "true" === p.storeHistory && !a.incognito && chrome.storage.local.get("word-history", function(b) {
        ...
        H = function(a) {
            ...
            var b = null,
                c = null;
            if (b = G(a, "entries[0]")) c = {
                prettyQuery: b.syllabifiedHeadword || b.headword,
                meaningText: G(b, "senseFamilies[0].senses[0].definition.text"),
                attribution: "",
                audio: G(b, "phonetics[0].drEyeAudio"),
                type: "licensedDef"
            }, c.meaningText ? c.audio && (c.audio = L(c.audio)) : c = null;
            !c && (b = G(a, "webDefinitions[0]")) && (c = b.sourceUrl, c = {
        ...
        P = function() {
            ...
            chrome.storage.local.get("word-history", function(a) {
                a["word-history"] || chrome.storage.local.set({
                    "word-history": {}
                })
            });
    ...
    window.initBackgroundPageAsync = function(a) {
        gapi.client.setApiKey("AIzaSyC9PDwo2wgENKuI8DSFOfqFqKP2cKAxxso");
        var b = function() {
            2 > Object.keys(q).length || (m = !0, a && a())
        };
        O("templates/browser_action_dict.html", function(a) {
            q.browser_action_dict = Mustache.compile(a);
            b()
        });
        O("templates/browser_action_tran.html", function(a) {
            q.browser_action_tran = Mustache.compile(a);
            b()
        })
    };
    window.initBackgroundPage = P;
    var Q = Q || !1;
    Q || P();
})();